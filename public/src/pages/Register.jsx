...
const FormContainer = styled.div`
  ...
  input {
    ...
    font-size: 1rem;
    &:focus {
      border: 0.1rem solid #4e0eff; /* Light purple border on focus */
      outline: none;
    }
  }
  button {
    background-color: #315a39; /* Medium green button background */
    ...
    text-transform: uppercase;
    &:hover {
      background-color: #315a39; /* Dark green on hover */
    }
  }
  span {
    color: white; /* White text color */
    text-transform: uppercase;
    a {
      color: #315a39; /* Light purple link color */
